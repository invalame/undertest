...
export async function updateSession(request: NextRequest) {
  ...
  // Si no hay variables, no intentamos inicializar nada para evitar el crash 500
  if (!supabaseUrl || !supabaseAnonKey) {
    console.warn('Faltan variables de entorno de Supabase. El middleware no se ejecutará.')
